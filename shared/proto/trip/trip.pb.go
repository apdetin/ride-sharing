...
type Trip struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	SelectedFarer *RideFare              `protobuf:"bytes,2,opt,name=selectedFarer,proto3" json:"selectedFarer,omitempty"`
...
func (x *Trip) GetSelectedFarer() *RideFare {
	if x != nil {
		return x.SelectedFarer
	}
	return nil
}
...
const file_trip_proto_rawDesc = "" +
	...
	"\rselectedFarer\x18\x02 \x01(\v2\x0e.trip.RideFareR\rselectedFarer\x12!\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	5,  // 7: trip.Trip.selectedFarer:type_name -> trip.RideFare
